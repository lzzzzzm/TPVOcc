...
def update_nuscenes_infos(pkl_path, out_dir, data_root):
    ...
    for i, ori_info_dict in enumerate(
        ...
        # add -------
        temp_data_info['ego2global_rotation'] = ori_info_dict['ego2global_rotation']
        temp_data_info['ego2global_translation'] = ori_info_dict['ego2global_translation']
        # --------
        ...
        # add -------
        temp_data_info['lidar_points']['lidar2ego_rotation'] = ori_info_dict['lidar2ego_rotation']
        temp_data_info['lidar_points']['lidar2ego_translation'] = ori_info_dict['lidar2ego_translation']
        # add ------
        ...
        for cam in ori_info_dict['cams']:
            ...
            intrinsic = ori_info_dict['cams'][cam]['cam_intrinsic']
            ...
            empty_img_info['lidar2cam'] = lidar2sensor.astype(
                np.float32).tolist()
            empty_img_info['lidar2img'] = lidar2img_rt
        ...
        # ------------
        if 'occ_gt_path' not in ori_info_dict:
            assert 'occ_gt_path not in ori_info_dict!'
        else:
            temp_data_info['occ_gt_path'] = ori_info_dict['occ_gt_path']
