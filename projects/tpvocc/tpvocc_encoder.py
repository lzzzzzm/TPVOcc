...
class TPVOccEncoder(TransformerLayerSequence):
    def __init__(self,
                 *args,
                 pc_range=None,
        ...
        super(TPVOccEncoder, self).__init__(*args, **kwargs)
...
@MODELS.register_module()
class TPVOccTransformerEncoderLayer(BaseTransformerLayer):
    def __init__(self,
                 attn_cfgs,
                 ...
                 batch_first=True,
                 **kwargs):
        super(TPVOccTransformerEncoderLayer, self).__init__(
            attn_cfgs=attn_cfgs,
